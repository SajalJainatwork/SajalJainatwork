...
- 🔭 I’m currently working on  ETLT, AWS ☁️ (S3 🪣, IAM 🔐, Glue, Athena 🔍, EMR, Lambda, Redshift), SQL, Snowflake(DB, DWH, Streamlit, Cortex)❄️, ELT - DBT, Git (CI/CD 🔁), Github, Tableau 📊, Apache Airflow, Python 🐍, Azure DevOps, Qlik Compose, ETL - Alteryx, Agile, SQL Server, SAP,  Qlik View 📊 and Solution Architect | Principal Consultant | Lead Consultant | Senior Cloud Data Engineer role for different clients.
