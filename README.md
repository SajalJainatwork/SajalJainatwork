...
- 🔭 I’m currently working on  Snowflake ❄️, Snowflake Cortex, ELT - DBT 🧱, AWS ☁️ (S3 🪣, IAM 🔐, Glue,Athena 🔍, EMR, Lambda, Redshift 🟥), Streamlit, Azure DevOps, Qlik Compose, ETL - Alteryx, CI/CD 🔁, Git, SQL , SQL Server, Tableau📊, Apache Airflow ⏱️, SAP,  Qlik View  and Solution Architect | Principal Consultant | Lead Consultant | Senior Cloud Data Engineer role for different clients.
